# Rioxx v3 - schema specification example 15 September 2023

Refreshed example with schema adjustments arising from liaison between Herbert, Petr, Paul, & George.

Example includes inline code comments.
...
<rioxx xsi:schemaLocation="http://www.rioxx.net/schema/v3.0/rioxx/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rioxxterms="http://docs.rioxx.net/schema/v3.0/rioxxterms/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    ...
    <!-- @Petr COAR type applying for all the resources unless overwritten at a lower level -->
    <dc:type>https://purl.org/coar/resource_type/c_2df8fbb1</dc:type>
    
    <!-- @Petr schema.org type applying to all the resources unless overwritten at a lower level -->
    <dc:type>https://schema.org/ScholarlyArticle</dc:type>
    ...
    <!-- @Petr URL to landing page (direct URL, intentionally not a PID) -->
...
<!-- @Petr & @g3om4c Reinstatement of dc:relation, replacing rioxxterms:file -->
    ...
    <!-- @Petr relation to a PID that resolves to the repository landing page -->
    <dc:relation
            rel="cite-as">
        https://oai.core.ac.uk/oai:strathprints.strath.ac.uk:70117
    </dc:relation>

    <!-- @Petr relationship to a PID pointing outside of the custodianship of this repository -->
    <!-- @Petr note that coar_type here intentionally overwrites the coar_type at the root level -->  
	<!-- @g3om4c note re-labelling of property to confer external custodianship, as proposed by Petr and Herbert -->
    ...
    <!-- @Petr related  dataset stored outside of the custodianship of this repository -->
    <rioxxterms:ext_relation
            rel="cite-as"
    ...
    <!-- @Petr related software stored outside if the custodianshiop of this repository -->
    <rioxxterms:ext_relation
            rel="cite-as"
